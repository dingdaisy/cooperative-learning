...
# images_diff = res - res[,1]
# boxplot(c(images_diff)
#         ~sort(rep(1:(4+length(alphalist)), nsim)), 
#         #col = c(rep("white",4),"#ff8080", rep("#BCDEBC",length(alphalist)),
#         #        "#ff8080",rep("#BCDEBC",length(alphalist))),
#         names=c("Only Images","Only Genes", "Late", "Coop", alpha_axis), 
#         xlab="",ylab="", main="Difference with Only Images")
# abline(h=0, col="#ff8080", lty=2)
# 
# images_diff = res - res[,2]
# boxplot(c(images_diff)
#         ~sort(rep(1:(4+length(alphalist)), nsim)), 
#         #col = c(rep("white",4),"#ff8080", rep("#BCDEBC",length(alphalist)),
#         #        "#ff8080",rep("#BCDEBC",length(alphalist))),
#         names=c("Only Images","Only Genes", "Late", "Coop", alpha_axis), 
#         xlab="",ylab="", main="Difference with Only Proteomics")
# abline(h=0, col="#ff8080", lty=2)
